   ...
   def input(self, origin, text, bytes, match, event, args): 
      class CommandInput(unicode): 
         def __new__(cls, text, origin, bytes, match, event, args): 
            ...
            s.consumer_token = self.config.consumer_token
            s.consumer_secret = self.config.consumer_secret
            s.access_token = self.config.access_token
            s.access_secret = self.config.access_secret
            return s
